...
use crate::crypto::{
    Aes128Key, Crypto, Secp256EcdhPublicKey, Secp256r1Point, Secp256r1Scalar, Uint384,
    AES128_KEY_LEN, SECP256R1_ECDH_PUBLIC_KEY_ZEROED, SECP256R1_ECDH_SHARED_SECRET_LEN,
    SECP256R1_POINT_LEN, SECP256R1_SIGNATURE_LEN,
};
    ...
    > for p256::SecretKey
{
    ...
    fn dehydrate<'a>(&self, key: &mut [u8; 100]) -> Result<(), Error> {
    ...
    fn derive_shared_secret(
        ...
        shared_secret.copy_from_slice(slice);
    ...
    fn sign(&self, msg: &[u8], signature: &mut [u8; SECP256R1_SIGNATURE_LEN]) -> Result<(), Error> {
        ...
        signature[..signature_bytes.len()].copy_from_slice(&signature_bytes);
