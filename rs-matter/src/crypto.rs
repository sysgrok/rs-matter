...
pub type Secp256EcdhSharedSecret = [u8; SECP256R1_ECDH_SHARED_SECRET_LEN];
pub const SECP256R1_ECDH_SHARED_SECRET_ZEROED: Secp256EcdhSharedSecret =
    [0u8; SECP256R1_ECDH_SHARED_SECRET_LEN];

pub type Secp256EcdhPublicKey = [u8; SECP256R1_POINT_LEN];
pub const SECP256R1_ECDH_PUBLIC_KEY_ZEROED: Secp256EcdhPublicKey = [0u8; SECP256R1_POINT_LEN];
...
pub type FabricSecretKey = Secp256EcdhSharedSecret;
pub const FABRIC_SECRET_KEY_ZEROED: FabricSecretKey = SECP256R1_ECDH_SHARED_SECRET_ZEROED;

pub type FabricPublicKey = Secp256EcdhPublicKey;
pub const FABRIC_PUBLIC_KEY_ZEROED: FabricPublicKey = SECP256R1_ECDH_PUBLIC_KEY_ZEROED;
...
pub trait Crypto {
    ...
    fn public_key_secp256r1_hydrate(
        &self,
        dehydrated_public_key: &Secp256EcdhPublicKey,
    ...
    fn secret_key_secp256r1_hydrate(
        &self,
        dehydrated_secret_key: &Secp256EcdhSharedSecret,
...
>
{
    type PublicKey<'a>: PublicKey<KEY_LEN, SIGNATURE_LEN>
    where
        Self: 'a;
